...
# Header
st.title("💬 Xavier's  1st Chatbot")
st.caption("Up to you: customize your chatbot's behavior using the system prompt in the left sidebar")
...
st.sidebar.markdown("---")
st.sidebar.markdown("❤️ Made by [Xavier] (https://buildfastwithai.com)")
